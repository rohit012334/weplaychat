...
import { loginReseller, setLoading } from "@/store/resellerSlice";
...
const loginImageUrl =
  "https://images.unsplash.com/photo-1761839256545-4268b03606c0?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDF8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxODN8fHxlbnwwfHx8fHw%3D";
...
export default function ResellerLogin() {
  ...
  const { isAuth, isLoading } = useSelector((state: RootState) => state.reseller);
  ...
  // Redirect if already authenticated as reseller
  useEffect(() => {
    const isReseller = sessionStorage.getItem("currentRole") === "reseller";
    if (isReseller) {
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .lg-divider-line { flex: 1; height: 1px; background: #e8eaf2; }
        .lg-divider-text {
          font-size: 11px;
          font-weight: 600;
          color: #c0c8d8;
        ...
        .lg-reseller a:hover { color: #a855f7; text-decoration: underline; }
      ...
      <div className="lg-root">
        ...
        <div className="lg-left">
          ...
          <img src={loginImageUrl} alt="Reseller Login Visual" className="lg-left-img" />
          ...
          <div className="lg-left-content">
            ...
            <p>
              Manage your network and drive success. Sign in to your reseller
              account to manage your operations.
            </p>
          </div>
        </div>
        ...
        <div className="lg-right">
          ...
          <div className="lg-platform-pill">
            <span className="lg-platform-pill-dot" />
            <span className="lg-platform-pill-text">Reseller Panel</span>
          </div>
          ...
          <div className="lg-form">
            ...
            <div className="lg-field">
              ...
              {error.password && <span className="lg-error">{error.password}</span>}
            </div>
