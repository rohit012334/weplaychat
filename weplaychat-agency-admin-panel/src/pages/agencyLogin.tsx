...
const loginImageUrl =
  "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?q=80&w=1169&auto=format&fit=crop";
      ...
      <div className="lg-root">
        ...
        <div className="lg-left">
          ...
          <div className="lg-left-content">
            ...
            <p>
              Connect, chat, and spark real connections. Sign in to continue
              your journey on WePlay Chat.
            </p>
          </div>
        </div>
        ...
        <div className="lg-right">
          ...
          <div className="lg-form">
            ...
            <p className="lg-reseller">
              Are you a Reseller?{" "}
              <a href="/ResellerLogin">Reseller Login →</a>
            </p>
