      ...
      <div className="lg-root">
        ...
        <div className="lg-left">
          ...
          <div className="lg-left-content">
            ...
            <h1>
              Welcome back,<br />
              <span className="hl">Manager</span>
            </h1>
            <p>
              Connect, manage, and grow your platform. Sign in to access your
              full manager dashboard and take control.
            </p>
          </div>
        </div>
        ...
        <div className="lg-right">
          ...
          <div className="lg-admin-pill">
            ...
            <span className="lg-admin-pill-text">Manager Panel</span>
          </div>

          <h2 className="lg-title">Manager Login</h2>
          <p className="lg-subtitle">
            Enter your credentials to access the WePlay Chat manager dashboard
