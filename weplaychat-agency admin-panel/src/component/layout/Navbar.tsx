...
const Navbar = () => {
  ...
  const handleNotify = (id: any) =>
    dispatch(openDialog({ type: "notification", data: { id, type: "host", allHost: true } }));
  ...
  const adminEmail = admin?.email || "agency@weplaychat.com";
  ...
  return (
    <>
      ...
      <header className="wpc-nb">
        ...
        {/* ── Left: hamburger + fullscreen ── */}
        <div style={{ display: "flex", alignItems: "center", gap: "6px", marginRight: "10px", flexShrink: 0 }}>
          <button className="nb-icon navToggle" title="Toggle Sidebar">
          ...
          <button className="nb-icon" onClick={enterFullscreen} title="Fullscreen">
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" strokeWidth="2.2" strokeLinecap="round">
        ...
        <div className="nb-search">
          ...
          <input type="text" placeholder="Search hosts, requests, reports…" />
        </div>
          ...
          <div ref={dropdownRef} style={{ position: "relative" }}>
            ...
            {showDropdown && (
              <div className="nb-drop">
                ...
                <div className="nb-db">
                  <Link href="/agencyProfile" className="nb-di"
